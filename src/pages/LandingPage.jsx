        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/20">
            ...
            <footer className="text-white py-8" style={{ backgroundColor: '#0D234C' }}>
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="border-t border-slate-800 pt-4 flex flex-col md:flex-row items-center justify-between">
                        <div className="text-slate-400 text-xs mb-2 md:mb-0">
