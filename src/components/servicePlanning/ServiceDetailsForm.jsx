      ...
      <CardContent className="pt-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-t pt-4">
            <h3 className="font-semibold text-slate-900 mb-3">Resource Bookings</h3>
            <p className="text-sm text-slate-600 mb-2">
              Resources will be automatically booked when this service plan is published. 
              Manage resource bookings in{" "}
              <a href="/ResourceManagement" className="text-blue-600 hover:underline">Resource Management</a>
            </p>
          </div>
